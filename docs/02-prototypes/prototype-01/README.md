...
Phase 1〜3はCompleted。仕様PR #29・Unity PR #6のMergeと現在の基準SHAは[Roadmap](./roadmap.md)、Phase 3の検証結果は[Phase 3 Spec §18.1・§18.2](../../03-system-specs/prototype-01/phase-03-task-system.md)を参照。OQ-P3-01／02はResolved。D-024によりPhase 3以降はApproved System Specを唯一のNormative Implementation Authorityとする。
